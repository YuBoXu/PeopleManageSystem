...
<body>
<div id="man_zone">
<form name="form" id="fom" method="post" action="PageGoFindLeaveServlet">
              ...
              <tr>
               <!--  <td width="50%">共 <span class="right-text09">5</span> 页 |
                ...
                <td width="49%" align="right">[<a href="#" class="right-font08">首页</a> |
                 ...
                 <td width="50%">共 <span class="right-text09">${sessionScope.pagenumber }</span> 页 |
               ...
               <c:if test="${sessionScope.pageindex==sessionScope.pagenumber }">   
                ...
                <td width="1%"><table width="20" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <td width="87%"><input name="Submit23222" type="submit" class="right-button06" value="确  定" />
                      </td>
                    </tr>
                </table></td>
              </tr>
