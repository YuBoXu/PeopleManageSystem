...
<div id="man_zone">
  ...
  <table width="95%" border="0.5" align="center" bordercolor="#0C057E" bgcolor="#FFFFFF">
    ...
    <tr>
      <td colspan="9">共 <span class="right-text09">5</span> 页 | 第 <span class="right-text09">1</span> 页</td>
      <td colspan="2" nowrap="nowrap">[<a href="#" class="right-font08">首页</a> | <a href="#" class="right-font08">上一页</a> | <a href="#" class="right-font08">下一页</a> | <a href="#" class="right-font08">末页</a>] </td>
    </tr>
</table>
</div>
</body>
