...
<body>
<div id="man_zone">
  <form action="SendAllEmailServlet" onsubmit="return link();" method="post" name="fom" id="fom" target="manFrame" >
    <div class="MainDiv">
      ...
      <br />
      <div align="center">
        <input type="submit" name="Submit"  class= "myButton1" value="群 发" />
        &nbsp;&nbsp;
        &nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
